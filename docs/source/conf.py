...
man_pages = [
    (master_doc, 'logging2', 'logging2 Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'logging2', 'logging2 Documentation', author, 'logging2', 'One line description of project.', 'Miscellaneous'),
]
