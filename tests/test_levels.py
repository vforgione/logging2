...
def test_lt():
    assert LogLevel.debug < LogLevel.info < LogLevel.warning < LogLevel.error < LogLevel.exception
...
def test_ge():
    assert LogLevel.exception >= LogLevel.error >= LogLevel.warning >= LogLevel.info >= LogLevel.debug
    assert LogLevel.debug >= LogLevel.debug
